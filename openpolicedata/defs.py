...
class _Columns:
    ...
    TIME = "TIME"
    DATETIME = "DATETIME"
    RACE_CIVILIAN = "SUBJECT_RACE"
    RACE_ONLY_CIVILIAN = "SUBJECT_RACE_ONLY"
    ETHNICITY_CIVILIAN = "SUBJECT_ETHNICITY"
